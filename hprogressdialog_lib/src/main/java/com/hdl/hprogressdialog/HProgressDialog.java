package com.hdl.hprogressdialog;
 ...
 * @author HDL
 */
public class HProgressDialog implements View.OnClickListener {
    ...
    public HProgressDialog(Context context, Builder builder) {
        mContext = context;
        mBuilder = builder;
        //初始化
        initDialog();
    ...
    public static final class Builder {
        ...
        public HProgressDialog build() {
            return new HProgressDialog(mContext, this);
        }
